...
RUN echo "spring.datasource.url=${MYSQL_URL:-jdbc:mysql://petclinicdb-instance-1.c0dng319gujr.eu-west-3.rds.amazonaws.com:3306/petclinic}" >> src/main/resources/application-mysql.properties
